      ...
      <div class="p-4">
        ...
        <div class="flex items-center justify-between mb-3">
          <div class="flex items-center space-x-2 text-sm text-slate-400 font-mono">
            ...
            <span class="tracking-wide">NAVIGATION_MATRIX</span>
          </div>
            ...
            >
              ...
              >
                ...
                <Icon 
                  ...
                  :class="collapsedCategories.has(category.key) ? 'transform rotate-0' : 'transform rotate-0'"
                />
              </button>
            </div>
...
const toggleCollapseAll = () => {
  ...
  if (allCollapsed.value) {
    collapsedCategories.value = new Set(categories.map(c => c.key))
  } else {
...
const getIndicatorClasses = (item: TocItem) => {
  if (props.activeSection === item.id) {
    return 'bg-gradient-to-br from-cyan-400 to-blue-500 border-cyan-300 shadow-[0_0_8px_rgba(34,211,238,0.6)]'
  }
  return 'bg-slate-700/60 border-slate-500 group-hover:border-cyan-400 group-hover:bg-cyan-500/20 group-hover:shadow-[0_0_6px_rgba(34,211,238,0.4)]'
}
