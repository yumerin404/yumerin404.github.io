...
const defaultPosts = [
  ...
  {
    id: 'stupidity-discrimination-philosophy',
    title: '我的人生哲學：實力歧視與蠢人問題',
    content: `有些人的蠢，是自己察覺不到的，而且蠢的特別令人討厭。
我的人生哲學之中，有兩個致命性卻是我主動選擇的特典：

1. 實力歧視，歧視那些實力比我還差的人，我屬於很笨的那種了，還比我還笨還沒能力的，我都應該歧視。
2. 無法忍受蠢，萬惡以蠢為首，蠢人比惡人還更加可惡，一但我看到蠢，我就特別的想躲開，那種惡臭令我無法接受。

上述兩點，基本上能讓我濾掉那些不值得我花時間的人。
這兩種人，也不會給你什麼有價值的事物，就算有錢或是位子很高，這種人必然會被自己的愚蠢跟沒有什麼實力讓自己身敗名裂。

而且要知道，如同金字塔原理，蠢人跟弱者站了人類的多數，20：80法則，80 ％ 都是愚昧且無知的。
躲開這些人，對自己的成長才有幫助。
近朱者赤，近墨者黑，你周圍的朋友的平均等於你的平均，所以跟聰明人打交道，不要跟笨蛋打交道。`,
    excerpt: '有些人的蠢，是自己察覺不到的，而且蠢的特別令人討厭。我的人生哲學之中，有兩個致命性卻是我主動選擇的特典...',
    date: '2025-08-29',
    readTime: 4,
    wordCount: 280,
    tags: ['人生哲學', '實力主義', '人性分析', '社會觀察', '個人原則']
  }
]
